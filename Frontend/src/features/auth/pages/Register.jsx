            ...
            <div className="w-full lg:w-1/2 h-full overflow-y-auto bg-[#0e0e0e] flex-shrink-0">
                <div className="min-h-full flex items-center justify-center p-6 sm:p-10 lg:p-14">
                    <div className="w-full max-w-md">
                        ...
                        <div className="mb-10">
                            <p className="text-xs uppercase tracking-widest text-[#FFD700] font-medium mb-3">Welcome to Snitch</p>
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-7">
                            ...
                            <div className="flex flex-col gap-1.5">
                                <label className="text-xs text-[#999077] uppercase tracking-widest font-medium">Full Name</label>
                                <input
                                    type="text"
                                    name="fullName"
                                    ...
                                    style={{ WebkitBoxShadow: '0 0 0 1000px #0e0e0e inset', WebkitTextFillColor: '#ffffff' }}
                                />
                            </div>

                            {/* Contact Number */}
                            <div className="flex flex-col gap-1.5">
                                <label className="text-xs text-[#999077] uppercase tracking-widest font-medium">Contact Number</label>
                                <input
                                    type="tel"
                                    name="contactNumber"
                            ...
                            <div className="flex items-center gap-3 group w-max cursor-pointer">
                                <div className="relative flex items-center">
                                    ...
                                    />
                                    <svg className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 pointer-events-none opacity-0 peer-checked:opacity-100 text-[#131313]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round">
                                        <polyline points="20 6 9 17 4 12"></polyline>
                                    </svg>
                                </div>
                                <label htmlFor="isSeller" className="text-sm text-[#999077] group-hover:text-[#FFD700] cursor-pointer select-none transition-colors duration-300 tracking-wide">
                                    Register as Seller
                                </label>
                            </div>
                            ...
                            <p className="text-center text-sm text-[#4d4732] pb-4">
                                ...
                                <a href="/login" className="text-[#999077] hover:text-[#FFD700] transition-colors duration-300 border-b border-transparent hover:border-[#FFD700] pb-0.5">
                                    Sign in
                                </a>
                            </p>
